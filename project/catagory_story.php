...
<html lang="en">
  <head>
    <title>Catagory-Short_Story</title>
    <!-- Required meta tags -->
    <meta charset="utf-8" />
    <meta
      name="viewport"
                  ...
                  <ul>
                    ...
                    <li>
                        <select name="catagory" id="catagory" onchange="goToPage(this)">
                              ...
                              <option value="catagory_story.php" selected>Short Story</option>
...
<!-- -----------------------------------catagory------------------------------------ -->
    <div class="text">
      <p>Explore All Short Story Books Here</p>
    </div>
    ...
    <div class="container">
      ...
      <div class="row mt-5">
        <div class="col-lg-3">
          <form action="manage_story.php" method="POST">
          <div class="catagory1">
            <div class="book-img">
              <img src="./images/golpoguchha.webp" alt=""/>
            </div>
            <div class="book-name">
              <p>Golpoguchha</p>
            </div>
            ...
            <div class="add-to-cart">
              <div class="icon-text">
                <div class="atc">
                  ...
                  <input type="hidden" name="item_name" value="Golpoguchha">
            ...
            <div class="catagory1">
              ...
              <div class="add-to-cart">
                <div class="icon-text">
                  <div class="atc">
                    <button type="submit" name="Add_To_Cart"><i class="fa-solid fa-cart-shopping"></i> Add to Cart</button>
                    <input type="hidden" name="item_name" value="Kaalpurush">
        ...
        <div class="col-lg-3">
          ...
          <div class="catagory1">
            ...
            <div class="book-author bibhu">
              <p>Sarat Chandra Chattopadhyay</p>
            </div>
            <div class="book-price">
              <p>Rs. 600/-</p>
            </div>
            <div class="add-to-cart">
              <div class="icon-text">
                <div class="atc">
                  <button type="submit" name="Add_To_Cart"><i class="fa-solid fa-cart-shopping"></i> Add to Cart</button>
                  <input type="hidden" name="item_name" value="Abhagir Swarga">
        ...
        <div class="col-lg-3">
          ...
          <div class="catagory1">
            <div class="book-img">
              <img
                src="./images/Manusher-Ghorbari.jpg"
                alt=""
              />
            </div>
            <div class="book-name">
              <p>Manusher Ghorbari</p>
            </div>
            <div class="book-author">
              <p>Atin Bandyopadhyay</p>
            </div>
            <div class="book-price">
              <p>Rs. 450/-</p>
            </div>
            <div class="add-to-cart">
              <div class="icon-text">
                <div class="atc">
                  <button type="submit" name="Add_To_Cart"><i class="fa-solid fa-cart-shopping"></i> Add to Cart</button>
                  <input type="hidden" name="item_name" value="Manusher Ghorbari">
  ...
  <div class="row mt-5">
        <div class="col-lg-3">
          ...
          <div class="catagory1">
            <a href="#"><div class="book-img">
              <img src="./images/bokul_katha.jpg" alt=""/>
            </div>
            </a>
            <div class="book-name">
              <p>Bokul Katha</p>
            ...
            <div class="add-to-cart">
              <div class="icon-text">
                <div class="atc">
                  <button type="submit" name="Add_To_Cart"><i class="fa-solid fa-cart-shopping"></i> Add to Cart</button>
                  <input type="hidden" name="item_name" value="Bokul Katha">
        ...
        <div class="col-lg-3">
          ...
          <div class="catagory1">
            <div class="book-img">
              <img
                src="./images/rabibarer_galpo.webp"
                alt=""
              />
            </div>
            <div class="book-name">
            ...
            <div class="add-to-cart">
              <div class="icon-text">
                <div class="atc">
                  <button type="submit" name="Add_To_Cart"><i class="fa-solid fa-cart-shopping"></i> Add to Cart</button>
                  <input type="hidden" name="item_name" value="Rabibarer Galpo">
                  <input type="hidden" name="price" value="400">
                </div>
              </div>
            </div>
          ...
          <div class="catagory1">
            ...
            <div class="add-to-cart">
              <div class="icon-text">
                <div class="atc">
                  <button type="submit" name="Add_To_Cart"><i class="fa-solid fa-cart-shopping"></i> Add to Cart</button>
                  <input type="hidden" name="item_name" value="Mukhosh">
                  <input type="hidden" name="price" value="450">
                </div>
              </div>
            </div>
          ...
          <div class="catagory1">
            ...
            <div class="add-to-cart">
              <div class="icon-text">
                <div class="atc">
                  <button type="submit" name="Add_To_Cart"><i class="fa-solid fa-cart-shopping"></i> Add to Cart</button>
                  <input type="hidden" name="item_name" value="Vikharini">
