...
<html lang="en">
  <head>
    <title>Catagory-Science Fiction</title>
    <!-- Required meta tags -->
    <meta charset="utf-8" />
    <meta
      name="viewport"
                  ...
                  <ul>
                    ...
                    <li>
                        <select name="catagory" id="catagory" onchange="goToPage(this)">
                              ...
                              <option value="catagory_science.php" selected>Sci-Fi</option>
...
<!-- -----------------------------------catagory------------------------------------ -->
    <div class="text">
      <p>Explore All Science Fiction Books Here</p>
    </div>
    ...
    <div class="container">
      ...
      <div class="row mt-5">
        <div class="col-lg-3">
          <form action="manage_science.php" method="POST">
          <div class="catagory1">
            <div class="book-img">
              <img src="./images/sonku.jpg" alt=""/>
            </div>
            <div class="book-name">
              <p>Professor Sonku</p>
            </div>
            ...
            <div class="add-to-cart">
              <div class="icon-text">
                <div class="atc">
                  ...
                  <input type="hidden" name="item_name" value="Professor Sonku">
            ...
            <div class="catagory1">
              ...
              <div class="add-to-cart">
                <div class="icon-text">
                  <div class="atc">
                    <button type="submit" name="Add_To_Cart"><i class="fa-solid fa-cart-shopping"></i> Add to Cart</button>
                    <input type="hidden" name="item_name" value="Patal Ghar">
        ...
        <div class="col-lg-3">
          ...
          <div class="catagory1">
            <div class="book-img">
              <img
                src="./images/NAKSHATRALOKER DEBATATMA.jpg"
                alt=""
              />
            </div>
            <div class="book-name">
            ...
            <div class="add-to-cart">
              <div class="icon-text">
                <div class="atc">
                  <button type="submit" name="Add_To_Cart"><i class="fa-solid fa-cart-shopping"></i> Add to Cart</button>
                  <input type="hidden" name="item_name" value="DEBATATMA">
        ...
        <div class="col-lg-3">
          ...
          <div class="catagory1">
            <div class="book-img">
              <img
                src="./images/kisore_kolpo.webp"
                alt=""
              />
            </div>
            <div class="book-name">
              <p>Kisore Kolpobigyan</p>
            </div>
            <div class="book-author">
            ...
            <div class="add-to-cart">
              <div class="icon-text">
                <div class="atc">
                  <button type="submit" name="Add_To_Cart"><i class="fa-solid fa-cart-shopping"></i> Add to Cart</button>
                  <input type="hidden" name="item_name" value="Kisore Kolpobigyan">
  ...
  <div class="row mt-5">
        <div class="col-lg-3">
          ...
          <div class="catagory1">
            <a href="#"><div class="book-img">
              <img src="./images/Antim_Abhijan.jpg" alt=""/>
            </div>
            </a>
            <div class="book-name">
              <p>Antim Abhijan</p>
            ...
            <div class="add-to-cart">
              <div class="icon-text">
                <div class="atc">
                  <button type="submit" name="Add_To_Cart"><i class="fa-solid fa-cart-shopping"></i> Add to Cart</button>
                  <input type="hidden" name="item_name" value="Antim Abhijan">
        ...
        <div class="col-lg-3">
          ...
          <div class="catagory1">
            <div class="book-img">
              <img
                src="./images/Jatiswarer_Punthi.jpg"
                alt=""
              />
            </div>
            <div class="book-name">
              <p>Jatiswarer Punthi</p>
            </div>
            <div class="book-author">
              <p>Viktar Bondyopadhyay</p>
            </div>
            <div class="book-price">
              <p>Rs. 800/-</p>
            </div>
            <div class="add-to-cart">
              <div class="icon-text">
                <div class="atc">
                  <button type="submit" name="Add_To_Cart"><i class="fa-solid fa-cart-shopping"></i> Add to Cart</button>
                  <input type="hidden" name="item_name" value="Jatiswarer Punthi">
                  <input type="hidden" name="price" value="800">
                </div>
              </div>
            </div>
        ...
        <div class="col-lg-3">
          ...
          <div class="catagory1">
            <div class="book-img">
              <a href="#"><img
                src="./images/Kalpabigyan_Samagra.jpg"
                alt=""
              />
              </a>
            </div>
            <div class="book-name font-19">
              <p>Kalpabigyan Samagra </p>
            </div>
            <div class="book-author">
              <p>Anish Deb</p>
            </div>
            ...
            <div class="add-to-cart">
              <div class="icon-text">
                <div class="atc">
                  <button type="submit" name="Add_To_Cart"><i class="fa-solid fa-cart-shopping"></i> Add to Cart</button>
                  <input type="hidden" name="item_name" value="Kalpabigyan Samagra ">
                  <input type="hidden" name="price" value="400">
                </div>
              </div>
            </div>
          ...
          <div class="catagory1">
            ...
            <div class="add-to-cart">
              <div class="icon-text">
                <div class="atc">
                  <button type="submit" name="Add_To_Cart"><i class="fa-solid fa-cart-shopping"></i> Add to Cart</button>
                  <input type="hidden" name="item_name" value="Aparadh Bigyan">
                  <input type="hidden" name="price" value="500">
                </div>
              </div>
            </div>
